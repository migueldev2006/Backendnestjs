...
export class Migration1756302615686 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "municipios" ("id_municipio" SERIAL NOT NULL, "nombre" character varying(70), "departamento" character varying(100), "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_da5d86d82419fc6467cd4f3fa83" PRIMARY KEY ("id_municipio"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "centros" ("id_centro" SERIAL NOT NULL, "nombre" character varying(70), "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_municipio" integer, CONSTRAINT "PK_93d07f4fb0a5e3876897b2bce66" PRIMARY KEY ("id_centro"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "sedes" ("id_sede" SERIAL NOT NULL, "nombre" character varying(70), "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_centro" integer, CONSTRAINT "PK_401bce17f4f7abe8670e9ece642" PRIMARY KEY ("id_sede"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "usuario_ficha" ("id_usuario_ficha" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_ficha" integer, "fk_usuario" integer, CONSTRAINT "PK_072265536cf170c9073957971cf" PRIMARY KEY ("id_usuario_ficha"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "fichas" ("id_ficha" SERIAL NOT NULL, "codigo_ficha" integer NOT NULL, "estado" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_programa" integer, CONSTRAINT "PK_857eaea7142102a2f3d223e12c5" PRIMARY KEY ("id_ficha"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "programas_formacion" ("id_programa" SERIAL NOT NULL, "nombre" character varying(70) NOT NULL, "estado" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_area" integer, CONSTRAINT "PK_b0d49e5d3ad80a48b383d459301" PRIMARY KEY ("id_programa"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "caracteristicas" ("id_caracteristica" SERIAL NOT NULL, "nombre" character varying(70), "simbolo" character varying(50), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_52e73803f4f7ca4fa6ef0954cba" PRIMARY KEY ("id_caracteristica"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "categorias" ("id_categoria" SERIAL NOT NULL, "nombre" character varying(70), "codigo_unpsc" text, "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_04bae980e284752e914bce1cbc7" PRIMARY KEY ("id_categoria"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "unidades_medida" ("id_unidad" SERIAL NOT NULL, "nombre" character varying(70) NOT NULL, "estado" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ca39afd476a07a87d3c3faf916c" PRIMARY KEY ("id_unidad"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "elementos" ("id_elemento" SERIAL NOT NULL, "nombre" character varying(70), "descripcion" character varying(205), "perecedero" boolean, "no_perecedero" boolean, "estado" boolean, "fecha_vencimiento" date, "baja" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "imagen" character varying(255), "fk_caracteristica" integer, "fk_categoria" integer, "fk_unidad_medida" integer, CONSTRAINT "PK_1d2dba8c68f03b6d62478514622" PRIMARY KEY ("id_elemento"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "tipo_movimientos" ("id_tipo" SERIAL NOT NULL, "nombre" character varying(70), "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_44b7e6b22ba4d09d3868fc9c388" PRIMARY KEY ("id_tipo"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "codigo_inventario" ("id_codigo_inventario" SERIAL NOT NULL, "codigo" text NOT NULL, "uso" boolean NOT NULL DEFAULT false, "baja" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_inventario" integer, "fk_movimiento" integer, CONSTRAINT "PK_ffdecb48e8c3f594845b0ab4e56" PRIMARY KEY ("id_codigo_inventario"))`);
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "inventarios" ("id_inventario" SERIAL NOT NULL, "stock" integer NOT NULL DEFAULT '0', "estado" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_elemento" integer, "fk_sitio" integer, CONSTRAINT "PK_2c4442a91d7530d5b410d640d8c" PRIMARY KEY ("id_inventario"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "tipo_sitios" ("id_tipo" SERIAL NOT NULL, "nombre" character varying(70), "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_22a8489e7e3a66f3b1ebcf31f1a" PRIMARY KEY ("id_tipo"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "sitios" ("id_sitio" SERIAL NOT NULL, "nombre" character varying(70), "persona_encargada" character varying(70), "ubicacion" character varying(205), "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_area" integer, "fk_tipo_sitio" integer, CONSTRAINT "PK_726f70836f94825b76c974b5d24" PRIMARY KEY ("id_sitio"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "areas" ("id_area" SERIAL NOT NULL, "nombre" character varying(70) NOT NULL, "estado" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_sede" integer, "fk_usuario" integer, CONSTRAINT "PK_9d2a9f5b563d6a8a9703a8fa9cd" PRIMARY KEY ("id_area"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "modulos" ("id_modulo" SERIAL NOT NULL, "nombre" character varying(70), "descripcion" character varying(205), "href" character varying(205), "icono" character varying(205) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "estado" boolean, CONSTRAINT "PK_68ad50fa332064a72e31fcdf87a" PRIMARY KEY ("id_modulo"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "rutas" ("id_ruta" SERIAL NOT NULL, "nombre" character varying(205), "descripcion" character varying(205), "href" character varying(205) NOT NULL, "icono" character varying(205), "listed" boolean NOT NULL, "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_modulo" integer, CONSTRAINT "PK_5969d8e88a11612682925e9275a" PRIMARY KEY ("id_ruta"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "permisos" ("id_permiso" SERIAL NOT NULL, "permiso" character varying(100), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_ruta" integer, CONSTRAINT "PK_76e2dbb965cd631705b6caaf698" PRIMARY KEY ("id_permiso"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "rol_permiso" ("id_rol_permiso" SERIAL NOT NULL, "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_permiso" integer, "fk_rol" integer, CONSTRAINT "PK_151312cfdb886f6d9dc19f9ccfd" PRIMARY KEY ("id_rol_permiso"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "roles" ("id_rol" SERIAL NOT NULL, "nombre" character varying(70), "estado" boolean, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_25f8d4161f00a1dd1cbe5068695" PRIMARY KEY ("id_rol"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "notificaciones" ("id_notificacion" SERIAL NOT NULL, "titulo" character varying(205) NOT NULL, "mensaje" character varying(500), "leido" boolean NOT NULL DEFAULT false, "requiereAccion" boolean NOT NULL DEFAULT false, "estado" character varying(50), "data" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_usuario" integer, CONSTRAINT "PK_ff498b8eb6b226a9fc52889ddac" PRIMARY KEY ("id_notificacion"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "usuarios" ("id_usuario" SERIAL NOT NULL, "documento" integer, "nombre" character varying(70), "apellido" character varying(70), "edad" integer, "telefono" character varying(15), "correo" character varying(70), "estado" boolean, "cargo" character varying(70), "password" character varying(60), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "perfil" character varying(255), "fk_rol" integer, CONSTRAINT "UQ_604e2077971f192d85cffb5c437" UNIQUE ("documento"), CONSTRAINT "PK_dfe59db369749f9042499fd8107" PRIMARY KEY ("id_usuario"))`);
